...
6.	A tidy data set is then created containing the mean of each feature for each subject and each activity and this file is written out to the directory as a txt file.
